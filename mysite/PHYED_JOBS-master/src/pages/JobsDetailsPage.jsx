...
const JobsDetailsPage = () => {
  ...
  return (
    <div className="p-3 md:px-16 md:py-10">
      <div className="bg-blue-400 rounded-md px-2 py-1 w-fit my-4">
        <Link to='/' > < TiArrowBack className="text-2xl text-white" /> </Link>
      </div>
      <section >
        {listOfJobs
              ...
              <div key={index}>
                <section className="bg-white dark:bg-slate-700 rounded-lg overflow-x-hidden p-4">
                  <article className="flex justify-between">
                    ...
                    {/* <Link to='/jobs/:id'> < BiLinkExternal className='4xl' /> </Link>  */}
                  </article>
                ...
                <section className="p-4 font-hanek flex justify-between">
                  ...
                  <div className="mt-4">
                    <Link className="bg-blue-600 text-white px-16 py-3 rounded-lg">
                      Apply
                    </Link>
                  </div>
                </section>
                ...
                <section className="bg-white dark:bg-slate-700 rounded-lg overflow-x-hidden mt-4">
                  <div className="p-4">
                    <h5 className="font-semibold border-l-4 h-5 border-blue-500 pl-6">Important dates & deadlines?</h5>
