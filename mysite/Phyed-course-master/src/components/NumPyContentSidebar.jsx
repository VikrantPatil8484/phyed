...
import NumPylist from "./NumPyData";
import { BiMenu } from "react-icons/bi";
import CoursesList from "./CoursesList";
import SubMenu from "./SubMenu";

const NumPyContentSidebar = ({ children }) => {
  ...
  return (
    ...
    <div className='flex h-fit'> 
        ...
        >
            <h4 className='py-4 text-xl px-2'>NumPy Tutorial</h4>
        {
            NumPylist.map((item, id) => {  
                return (
                    (
...
export default NumPyContentSidebar;
